    ...
    boolean flag = false;
        ...
        String result = "";
            ...
            public void calculateResult(String result) {
                        ...
                        resultView.setText(sedersograim(result3));
            ...
            public String sedersograim(String[] str)
            {
                        ...
                        for(int y = 0;y < countersograim;y++) {
                            ...
                            if (flag7 == true) {
                                ...
                                str[mikom1] = sederPeolot(result3);
        ...
        public String sederPeolot(String[] str){
